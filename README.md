# Análise de Compras Online (SQL + Excel)

Projeto desenvolvido para praticar SQL e análise de dados utilizando o SQLite, VS Code e Excel para geração de gráficos utilizando um DataBase público simulado.
